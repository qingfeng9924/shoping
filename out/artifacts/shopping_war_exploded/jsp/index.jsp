                        ...
                        <ul class="category-list" id="js_climit_li">
                            ...
                            <li class="appliance js_toggle relative first">
                                <div class="category-info">
                                    ...
                                    <div class="menu-item menu-in top" style="background-color: black;display:none" id="${firstClass.id}">
                                        <div class="area-in">
                                            <div class="area-bg">
                                                            <div class="menu-srot">
                                                                <div class="sort-side">
                                                                        <c:forEach items="${firstClass.goodsSecondClassList}" var="secondClass">
                                                                            <dl class="dl-sort">
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
                            ...
                            <%--<li class="appliance js_toggle relative">--%>
                                ...
                                <%--&lt;%&ndash;<div class="category-info">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<h3 class="category-name b-category-name"><i><img src="../images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<em>&gt;</em>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                                <%--<div class="menu-item menu-in top">--%>
                                    <%--<div class="area-in">--%>
